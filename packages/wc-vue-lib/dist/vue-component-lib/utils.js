...
const getComponentClasses = (classes) => {
  return (
    (classes === null || classes === void 0 ? void 0 : classes.split(' ')) || []
  );
};
const getElementClasses = (ref, componentClasses, defaultClasses = []) => {
  ...
  return [
    ...Array.from(
      ((_a = ref.value) === null || _a === void 0 ? void 0 : _a.classList) ||
        [],
    ),
    ...defaultClasses,
        ...
        eventsNames.forEach((eventName) => {
          el.addEventListener(eventName.toLowerCase(), (e) => {
            if (e.target.tagName === el.tagName) {
              modelPropValue = (e === null || e === void 0 ? void 0 : e.target)[
                modelProp
              ];
    ...
    const hasRouter =
      (_a =
        currentInstance === null || currentInstance === void 0
          ? void 0
          : currentInstance.appContext) === null || _a === void 0
        ? void 0
        : _a.provides[NAV_MANAGER];
    ...
    return () => {
      ...
      if (modelProp) {
        if (props[MODEL_VALUE] !== EMPTY_PROP) {
          propsToAdd = Object.assign(Object.assign({}, propsToAdd), {
